            ...
            <div key={item} className="col-lg-3 col-md-4 col-sm-6">
              <div className="card border-0 shadow h-100">
                <div className="position-relative">
                  ...
                  />
                  <span className="position-absolute top-0 end-0 m-2 badge bg-dark fs-6">20% OFF</span>
                </div>
                <div className="card-body d-flex flex-column">
                  <h6 className="fw-bold">Isi Ewu</h6>
                  <div className="d-flex align-items-center mb-2">
                    <span className="text-warning me-1 fs-5">★★★★★</span>
                    <small className="text-muted">{restaurant.rating} ({restaurant.reviews})</small>
                  </div>
                  <p className="fw-bold text-success mb-1 fs-5">₦5,000</p>
                  <p className="text-muted mb-3">Lagos Kitchen</p>
