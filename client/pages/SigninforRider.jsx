...
import rider from "../src/assets/ride.png";
import axios from "axios";
import { useNavigate } from "react-router-dom";

const SigninforRider = () => {
  ...
  const handleSignin = async (e) => {
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        showMessage("Rider Signed In Successfully", "success");
      ...
      >
        ...
        <div className="col-12 col-md-6 d-flex flex-column justify-content-center align-items-center p-4 p-md-5">
          <div style={{ width: "100%", maxWidth: "350px" }}>
            <h4 className="mb-4 fw-bold text-center">Sign In As A Rider</h4>
